...
%DA QUI
%With this dissertation we want to contribute to exponential growth of LTE-based multimedia services experienced in the last decade. Real use-cases are defined to prove that smart devices and ultra-broadband may be the enabling technology for LTE-based multimedia services.
