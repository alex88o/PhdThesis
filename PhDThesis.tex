...
\university{Università degli Studi di Catania ciao} % Your university's name and URL, this is used in the title page and abstract, print it elsewhere with \univname
...
\include{./TeX_files/chap1}
\include{./TeX_files/chap2}
\include{./TeX_files/chap3}
\include{./TeX_files/chap4}
\include{./TeX_files/chap5}
%----------------------------------------------------------------------------------------
